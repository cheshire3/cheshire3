"""Deprecated module maintained for backward compatibility with existing configs."""

# backward compatibility imports
from cheshire3.sql.postgresStore import PostgresIter, PostgresStore
from cheshire3.sql.documentStore import PostgresDocumentIter, PostgresDocumentStore
...
from cheshire3.sql.documentFactory import PostgresDocumentStream, PostgresDocumentFactory
